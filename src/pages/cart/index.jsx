      ...
      <div className="flex flex-col gap-1 w-[50%] max-[640px]:w-[100%] max-[640px]:order-3">
        {cart.map((product, index) => (
          <motion.div
            ...
            key={product.id}
            initial={{ opacity: 0, y: 20 }} // Меньшее смещение для повышения производительности
            animate={{ opacity: 1, y: 0 }}
            transition={{
              duration: 0.4, // Уменьшенная длительность для лучшей производительности
              delay: index * 0.1, // Увеличенная задержка для последовательного появления
              ease: "easeOut", // Упрощенная кривая Безье
            }}
          >
