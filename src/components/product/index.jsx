                ...
                <button
                  ...
                  className={`${
                    selectedVariantId === variant.id
                      ? "bg-transparent text-[rgb(30, 30, 33)] font-bold underline-offset-[3px] decoration-[1.5px] underline max-[640px]:border-b-2 max-[640px]:no-underline border-[rgb(30, 30, 33)] "
